    ...
    "passport_fresh": {
        ...
        "documents": [
            _doc("AADHAAR", "recommended",
                 ...
                 ["full_name", "date_of_birth", "gender", "address", "city", "state", "pincode", "father_name"]),
            ...
            _doc("PAN", "optional",
                 ...
                 ["full_name", "date_of_birth", "father_name", "document_number"]),
            _doc("VOTER_ID", "optional",
                 "Identity / address proof and Voter ID number",
                 "पहचान / पते का प्रमाण और वोटर आईडी नंबर",
                 ["full_name", "gender", "address", "father_name", "document_number"]),
            ...
            _doc("DRIVING_LICENCE", "optional",
                 ...
                 "पहचान / पते का प्रमाण",
                 ["full_name", "date_of_birth", "address", "pincode", "document_number"]),
        ],
    },
    "generic": {
        "form_id": "generic",
